                    ...
                    <div class="features-inner section-inner">
                        <div class="features-header text-center">
                            <div class="container-sm">
                                <h2 class="section-title mt-0">My Service</h2>
                                <p class="section-paragraph">Client satisfaction is number one for me 😎, I do my best for your project, what can I do?</p>
                            </div>
                        </div>
						<div class="features-wrap">
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Web Design</h4>
                                    <p class="text-sm">As much as possible I will provide a design for your website if you do not have it, I also give the right to redesign if you are not satisfied.</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Frontend</h4>
                                    <p class="text-sm">I created your web interface using a library that roughly React JS, Vue JS, SCSS, HTML, CSS and more.</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Source Code</h4>
                                    <p class="text-sm">for the finished project, I also provide 100% source code for you.</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Low Price</h4>
                                    <p class="text-sm">let me know the application concept and budget you have right now, and I will do my best on the project.</p>
                                </div>
                            </div>
						</div>
                    </div>
