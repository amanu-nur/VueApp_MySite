    ...
    <section class="hero">
      <div class="container">
        ...
        <div class="hero-inner">
          <div class="hero-copy">
            <h1 class="hero-title mt-0">Amanu Nur Abdillah</h1>
            <p class="hero-paragraph">
              Junior javascript & frontend developer.
            </p>
            <div class="hero-form field field-grouped">
              <button type="button" class="btn btn-outline-primary"  data-bs-toggle="modal" data-bs-target="#exampleModal">Download CV</button>
              <a type="button" href="mailto:amanunur401@gmail.com" class="btn btn-primary ml-3">Hire Me  <i class="fas fa-briefcase ml-2"></i></a>
            </div>
          </div>
